...
# --- Themed Welcome Message Box ---
if st.session_state.get("theme", "light") == "dark":
    # Dark mode styling
    st.markdown(
        """
        <div style='background-color:#1E1E2F; padding: 1rem; border-radius: 10px;'>
            <h4 style='color:#E4E6EB;'>Welcome Teacher 👩‍🏫 Use this dashboard to manage attendance and performance for your remedial classes.</h4>
        </div>
        """,
        unsafe_allow_html=True
    )
